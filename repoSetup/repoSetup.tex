...
The content of the \verb!name:! line
...
other courses on
\href{http://ximera.osu.edu/course}{\tt ximera.osu.edu/course}
you should change this title to something unique
...
\item The \verb!---!'s encapsulating the name and description
on lines 1 and 4
...
In other words, the only newlines permitted are the ones
