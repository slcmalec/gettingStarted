...
\begin{warning}
The \verb!course.xim! file has very specific formatting requirements:
\begin{enumerate}
\item The file name must be \verb!course.xim!
\item The three dashes encapsulating the name and description
are required, as is the blank line following the second set of dashes.
\item Each entry in between the set of three dashes must exist as a single line. 
\end{enumerate}
\end{warning}
