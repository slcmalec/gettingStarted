...
\begin{document}
\begin{abstract}
SageMathCloud is the easiest way for a new author to publish.
\end{abstract}
\maketitle

To publish your work to the internet, you will need a computer that
can run our tools. The developers of Ximera use \link[Arch Linux]{http://www.archlinux.org/}, but we believe that to be too difficult for the average user. Instead, we suggest you use \link[SageMathCloud]{http://cloud.sagemath.com/}.

Once you have a SageMathCloud account, you will need to start a new project
...
\end{image}
Now you will need to add a terminal to your SageMathCloud account, click on
\begin{image}
