...
This tutorial is intended to help course instructors to get a Ximera 
...
working on a computer running either Linux or OSX.
Similar instructions for Windows users will be composed
at a later stage, but the Linux instructions below will probably
be sufficient for Windows users familiar with Unix commands.
While the reader could in principle avoid installing \LaTeX
and \href{git}{http://git-scm.com} these programs are necessary
in order to take full advantage of the features of the Ximera system.

\begin{enumerate}
\item Create a directory for your course files
and change to that directory.
In this example, we will create a directory called \verb!anExampleCourse!.
