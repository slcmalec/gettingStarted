...
the resulting PDF file, which might be helpful for editing.
...
One could then produce
\href{http://ximera.osu.edu}{\sf Ximera} 
activities {\em witihout} a local copy of the repository.
...
or issue any of the operating system specific
