...
\section{Other ways to set up a Ximera repository}
Users familar with
\href{http://github.com}{\tt github.com}
will have probably noticed that
the order of the instructions above can be permuted.
...
one clones the copy on 
\href{http://github.com}{\tt github.com} using a
\verb!git clone! command.
This obviates step \autoref{Mkdir} since cloning
a \href{http://git-scm.com}{\sf git} repository
creates a directory and initializes
it as a \href{http://git-scm.com}{\sf git} repository.

From here one can create 
\href{http://ximera.osu.edu}{\sf Ximera} 
...
\href{http://github.com}{\tt github.com}.
You should also add the name of your file without
...
Observe however that once the filename of an activity
appears in \verb!course.xim! the activity will appear
to students. It might therefore be preferable
to {\em not} add the filename to \verb!course.xim!
until the activity is ready to show to students.
During the editing phase you can process the file using \LaTeX\
periodically in order to view the activity.
