...
accept all default the settings by pressing the green
...
\item Click the \verb!Settings! button on the
...
\href{http://ximera.osu.edu/course}{\tt ximera.osu.edu/course}.
If not, see the \verb!troubleshooting! activity in this tutorial
