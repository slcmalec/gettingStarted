...
\begin{warning} Currently {\em anyone} can follow
the instructions below to create a course on the webserver
...
visable to all the world. Therefore,
...
accept all default settings by pressing the green
...
activity. See the \verb!Question and answer types!
...
\href{http://ximera.osu.edu/course}{\tt ximera.osu.edu/course}.
If not, see the \verb!troubleshooting! activity
